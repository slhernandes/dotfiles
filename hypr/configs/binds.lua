...
hl.bind(MainMod .. "+ M",
        hl.dsp.exec_cmd("qs ipc call globalStates toggleMinimize false"))
-- hl.bind(MainMod .. "+ SHIFT + M",
--   hl.dsp.exec_cmd(ScriptDir .. "/minimize.py restorerofi"))
hl.bind(MainMod .. "+ SHIFT + M",
        hl.dsp.exec_cmd("qs ipc call globalStates toggleMinimize true"))
...
hl.bind(MainMod .. "+ SHIFT + W",
        hl.dsp.exec_cmd("qs ipc call globalStates toggleLauncher middle theme"))
-- hl.bind(MainMod .. "+ P", helper.launcher())
hl.bind(MainMod .. "+ P", hl.dsp
            .exec_cmd(
            "qs ipc call globalStates toggleLauncher center appLauncher"))
...
hl.bind(MainMod .. "+ SHIFT + P",
        hl.dsp.exec_cmd("qs ipc call globalStates toggleLauncher middle pdf"))
-- hl.bind(MainMod .. "+ Space", hl.dsp.exec_cmd(ScriptDir .. "/rofisearch.sh"))
hl.bind(MainMod .. "+ Space", hl.dsp
            .exec_cmd("qs ipc call globalStates toggleLauncher middle websearch"))
